                ...
                <tr>
                    <td>
                        ...
                        <div className='booking-box'>
                            ...
                            <h4 className='book-head' >Presidential Suite</h4>
                            <div className='book-details'>
                                <h3>Wifi</h3>
                            </div>
                            <div className='btns'>
                                <button onClick={bookRoom} className=' btn-book'><Link style={{ color: "white", textDecoration: "none" }} to='/reserve'>Book</Link></button>
                            ...
                            <div className='book-room' >
                                <img className='booking-pic' alt='book' src='https://firebasestorage.googleapis.com/v0/b/hotel-app-3b9df.appspot.com/o/roomImage%2Froom2.jpg?alt=media&token=c07ff4dc-580c-4149-8778-86a5caa9e96a'></img>
